...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::CodeBlock& node) {
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::Identifier& node) {
	out << node.name;
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::VariableInitialization& node) {
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::IfElse& node) {
	out << "if(";
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::Operator& node) {
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::FuncDeclaration& node) {
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::FuncCall& node) {
	node.name->accept(*this);
	out << "(";
	bool placeComma = false;
	for (auto& param : node.params)
...
void shader_precompiler::GlesVisitor::visit(shader_precompiler::ast::nodes::Func& node) {
